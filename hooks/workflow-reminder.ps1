...
$planReminder = 'Inspect the requested scope first. A small, localized edit with an obvious solution ' +
...
$evidenceReviewReminder = 'This request may include a read-only review. Route by mode before scope: rechecks, ' +
...
$safeCheckpointReminder = 'If the user is requesting a checkpoint or handoff, invoke safe-checkpoint before any ' +
