...
$planReminder = 'Inspect the requested scope first. For a small, localized edit with an obvious ' +
...
$evidenceReviewReminder = 'This request may include a read-only review. Resolve the current user intent and ' +
...
$safeCheckpointReminder = 'If the current user is requesting a checkpoint or handoff, invoke safe-checkpoint ' +
